...
\newcommand{\SWCarpentryLink}{\href{https://software-carpentry.org/}{Software Carpentry}}
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto]
  \begin{fa-ul}
    ...
    \\
    \aiGoogleScholarSquare & 221 citações no \href{https://scholar.google.com/citations?view\_op=view\_citation\&hl=en\&user=qfmPrUEAAAAJ\&citation\_for\_view=qfmPrUEAAAAJ:AXPGKjj\_ei8C}{Google Scholar}\footnotemark{} (acessado em 2025-04-13)
  \end{fa-ul}
\end{summarybox}
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto]
  \begin{fa-ul}
    ...
    \\
    \aiGoogleScholarSquare & 172 citações no \href{https://scholar.google.com/citations?user=qfmPrUEAAAAJ}{Google Scholar}\footnotemark{} (acessado em 2025-03-13)
  \end{fa-ul}
\end{summarybox}
...
\url{https://github.com/fatiando/pooch/network/dependents?dependent_type=PACKAGE} (acessada em 2025-04-13)}.
Como consequência, o Pooch agregou mais de 84 milhões de downloads\footnote{Segundo a página
\url{https://pepy.tech/project/Pooch} (acessada em 2025-04-13)} e 44 pessoas
...
\url{https://plausible.io/fatiando.org} (acessada em 2025-04-13)}.
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto GMT]
  \begin{fa-ul}
    ...
    \\
    \aiGoogleScholarSquare & 2389 citações no \href{https://scholar.google.com/citations?view\_op=view\_citation\&hl=en\&user=qfmPrUEAAAAJ\&citation\_for\_view=qfmPrUEAAAAJ:hkOj\_22Ku90C}{Google Scholar}\footnotemark{} (acessado em 2025-04-13)
  \end{fa-ul}
\end{summarybox}
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Informações sobre o projeto PyGMT]
  \begin{fa-ul}
    ...
    \\
    \aiGoogleScholarSquare & 167 citações no \href{https://scholar.google.com/citations?view\_op=view\_citation\&hl=en\&user=qfmPrUEAAAAJ\&citation\_for\_view=qfmPrUEAAAAJ:-\_dYPAW6P2MC}{Google Scholar}\footnotemark{} (acessado em 2025-04-13)
  \end{fa-ul}
\end{summarybox}
...
\begin{fancyenum}{\faRocket}{Impacto da pesquisa}
  \item O software Verde é utilizado regularmente pela comunidade científica
    ...
    a plataforma Google Scholar \url{https://scholar.google.com/citations?view_op=view_citation&hl=en&user=qfmPrUEAAAAJ&citation_for_view=qfmPrUEAAAAJ:ye4kPcJQO24C} (acessada em 2025-04-13)}
    e mais de 4000 downloads mensais\footnote{Segundo a página
    \url{https://pepy.tech/project/Verde} (acessada em 2025-04-13)}.
\end{fancyenum}
...
Minha primeira orientação a nível de graduação na USP foi a \EllenLink{}, que
realizou seu trabalho de conclusão de curso sob minha supervisão em 2024.
Seu projeto era investigar o uso de validação cruzada em blocos
\citep{Roberts2017} para estimar a melhor profundidade de fontes equivalentes
para processamento de dados magnéticos.
A Ellen apresentou seus resultados no X Simpósio Brasileiro de Geofísica da
SBGf e recebeu muitos elogios.
A experiência de trabalhar com a Ellen foi excelente e me mostrou o quanto faz
a diferença a formação da USP e do IAG em particular.
Com muito pouco esforço da minha parte, a Ellen conseguiu implementar se
projeto e idealizar experimentos para testar suas próprias hipóteses.
Ela demonstrou independência e maturidade na execução de um projeto complexo,
o que demonstra sua evolução de aluna para uma profissional completa.
Atualmente, a Ellen está trabalhando em uma empresa de software mas esperamos
muito que ela volte ao IAG para um mestrado.

Outra experiência extremamente positiva tem sido a orientação do aluno de
iniciação científica \GabrielLink{}.
Ele está desenvolvendo um projeto com bolsa PIBIC utilizando e expandindo
o método de inversão 3D por plantação que desenvolvi durante meu mestrado
\citep{Uieda2012} (seção~\ref{sec_planting}).
O Gabriel é um aluno muito dedicado e responsável.
Sempre está presente para as reuniões do grupo e está com seu projeto em
estágio mais adiantado do que esperávamos.
Tenho plena confiança de que seu projeto resultará em uma publicação de
qualidade e espero ver o que o Gabriel alcançará no futuro.

Em 2025, os alunos Paulo Eduardo Crystal e Felipe Nascimento Hong se juntaram
ao grupo com projetos de iniciação científica.
Ambos ainda estão sem bolsa mas temos planos de pedir bolsas PIBIC e FAPESP.
O projeto do Paulo será desenvolver o software
\href{https://github.com/fatiando/tremelique}{Tremelique} para modelagem 2D de
propagação de ondas elásticas, que é parte do Fatiando a Terra.
O código por trás desse projeto foi desenvolvido para minhas aulas de sísmica
na UERJ (seção~\ref{sec_ensino_grad}), que utilizavam notebooks e essas
simulações numéricas para ensinar a teoria de propagação de ondas
(figura~\ref{fig_notebooksismica}).
O papel do Paulo será modernizar esse código, implementar testes para garantir
que os resultados estão corretos e auxiliar outros docentes a utilizá-lo em
suas aulas.
Já o Felipe desenvolverá um projeto de pesquisa para criar um método de correção
topográfica de dados de gravimetria terrestre utilizando tesseroides
(seção~\ref{sec_modelagemdireta}).
O maior empecilho para essa correção é o fato da integração numérica do campo
gravitacional dos tesseroides decair em acurácia com a distância.
Por isso, investigaremos o uso das soluções analíticas de \citet{Deng2023}.
...
Na USP, minha abordagem didática não mudou consideravelmente.
Continuo com aulas que misturam a teoria e a prática com computadores para
explorar dados e tópicos complexos de maneira interativa.
Na disciplina ``AGG0110 - Elementos de Geofísica'', dividida com meus colegas
Marcelo Belentani de Bianchi e Daniele Cornellio de Paiva Caldeira Brandt,
ensino a estrutura interna da Terra e conceitos básicos de gravimetria
e a forma da Terra para estudantes do curso de Licenciatura em Geociências
e Educação Ambiental (LIGEA).
Essa disciplina é desafiadora por conta da grande mistura de estudantes, alguns
nos últimos anos do curso de física, outros ingressantes no LIGEA, outros da
ciência da computação.
Porém, é uma grande satisfação quando sou capaz de abordar o conteúdo no nível
correto para a turma e posso ver em suas perguntas que entenderam o que eu
queria passar.
Ministrei a disciplina optativa ``AGG0204 - Computação para Geofísicos'' junto
com meu colega Eder Cassola Molina em 2024.
Durante meu segmento da disciplina, os estudantes implementaram o cálculo do
modelo geomagnético IGRF em Python.
Utilizei essa tarefa complexa para ensiná-los sobre boas práticas de engenharia
de software, como modularidade e o uso de testes unitários.
Não continuarei com essa disciplina por conta do ingresso da Professora Renata
Regina Constantino Barrella que a assumiu em 2025.
Em 2024, assumi a maior parte das aulas da disciplina obrigatória ``AGG0011
- Problemas Integrados em Ciências da Terra I'' que visa introduzir conceitos
de programação e solução de problemas comuns a estudantes do primeiro e segundo
ano do curso de geofísica.
Baseio minhas aulas dessa disciplina no currículo do \SWCarpentryLink{} e na
formação que obtive da organização em como ensinar esses conceitos.
O resultado foi um feedback positivo dos estudantes que participaram na última
iteração da disciplina.
Por fim, ministro a disciplina ``AGG0669 - Gravimetria e Magnetometria
Aplicadas à Prospecção de Bens Minerais e Estruturas Crustais'' com meus
colegas Eder Cassola Molina e Renata Regina Constantino Barrella.
Essa é uma das últimas disciplinas obrigatórias do curso de geofísica e é minha
especialidade.
Em 2024, com a chegada da Renata, reformulamos o conteúdo da disciplina para
modernizar a abordagem e a forma como as anomalias são definidas e explicadas
e para introduzir conceitos recentes e de interesse dos estudantes, como
geofísica planetária e geofísica polar.
...
Na USP, criei a disciplina condensada ``AGG5954 - Modelagem e Interpretação de
Dados de Gravimetria e Magnetometria'' para a Escola de Versão de Geofísica em
2024.
Essa disciplina cobre uma lacuna existente na pós-graduação na área de métodos
potenciais.
No futuro, eu e minha colega Renata Regina Constantino Barrella pretendemos
expandi-la para uma disciplina semestral que cubra um conteúdo similar
à disciplina de métodos potenciais da graduação.

Em 2024, assumi a disciplina ``AGG5949 - Tópicos Gerais de Geofísica'', que
é obrigatória para estudantes de doutorado, junto a minha colega Andréa
Teixeira Ustra.
Nos semestres pares, eu e a Andreia somos os responsáveis pela disciplina
enquanto que nos semestres ímpares ela é dada pelos professores Carlos Alberto
Mendonça e Mauricio de Souza Bologna.
Essa disciplina envolve a escrita de duas monografias pelos estudantes em
tópicos que não sejam relacionados a suas teses.
Nosso objetivo é fazer com que saiam de suas zonas de conforto e adquiram uma
formação mais abrangente em geofísica.

Com o afastamento do meu colega Carlos Alberto Moreno Chaves em 2025, assumi
a disciplina optativa ``AGG5740 - Teoria de Inversão em Geofísica''.
Tem sido um prazer ministrá-la pois esse foi o tema da minha primeira
experiência didática com o curso de verão que ministrei no IAG em 2012.
Dessa vez, tenho anos a mais de experiência em sala de aula e estou mais atento
às necessidades dos estudantes.
Meu principal esforço tem sido encontrar problemas inversos para resolvermos em
sala que tenham uma relevância para os diferentes projetos dos estudantes.
Novamente, estou pareando deduções teóricas com a sua implementação prática em
linguagem Python.
...
Na USP, participei da 17ª Edição da Feira USP e as Profissões em 2023.
Durante a feira, conversei com alunos e alunas que passavam pela nossa
exposição.
Essa atividade foi muito gratificante e sinto que é um ótimo jeito de informar
estudantes de ensino médio sobre áreas menos populares da ciência como as
Ciências da Terra.
Infelizmente, o evento foi realizado de modo inteiramente virtual em 2024 e não
pude participar.
Também ministrei o curso ``Kit de sobrevivência digital para cientistas'' na
XXVII Escola de Verão de Geofísica do IAG que contou com a participação de
estudantes de outras universidades e de profissionais da área de geociências.
Recentemente, fui procurado pelo estudante de graduação Sami Lisboa Santos que
tem interesse em desenvolver um projeto de extensão.
Sami pretende construir um modelo em escala da Terra que possa ser desmontado
para mostrar suas camadas.
Além disso, iremos incluir um eletroímã na região do núcleo externo para gerar
um campo magnético que poderá ser medido na superfície do modelo, usado para
alinhar bússolas e demonstrar reversões do campo.
Nosso plano é submeter um projeto para uma bolsa e requisitar auxílio
financeiro da Pró-Reitoria de Cultura e Extensão da USP.
...
Este memorial contém um relato dos últimos 21 anos, desde minha entrada no
curso de Bacharelado em Geofísica da \USP{} até minha
posição atual como Professor Doutora na \USP{}.
Ao longo desse caminho, passei por 6 instituições em 4 países, fui autor de 18
artigos científicos e uma gama de softwares livres para ciência, ministrei 14
disciplinas diferentes de graduação e orientei e coorientei 21 alunos de
...
Sou ativo na comunidade acadêmica internacional, tendo papeis de liderança em
múltiplas organizações sem fins lucrativos.
